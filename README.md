...
Record daily wellbeing information

🧠 AI Risk Prediction

Generate an AI-assisted wellbeing risk category

📔 Smart Journal

Write reflections and receive emotion/mood analysis

📈 Wellbeing Trends

View recent wellbeing and stress patterns

🎯 Weekly Goals

Set goals and track daily progress

🧘 Exercises

Access guided wellbeing exercises
...
Interact with an AI wellbeing assistant

🤝 Community

Share and react to supportive posts
...
Access emergency/support pathways

✉️ Weekly Digest

Receive an aggregated wellbeing summary
